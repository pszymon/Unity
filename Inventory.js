...
function Update()
{
	...
	if(showGUI == true)
	{
		...
		GameObject.Find("Main Camera").GetComponent(RayCastCollectWood).enabled = false;
		GameObject.Find("Main Camera").GetComponent(RayCastCollectStone).enabled = false;
	}
	...
	if(showGUI == false)
	{
		...
		GameObject.Find("Main Camera").GetComponent(RayCastCollectWood).enabled = true;
		GameObject.Find("Main Camera").GetComponent(RayCastCollectStone).enabled = true;
